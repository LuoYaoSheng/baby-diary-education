...
type ToolsGenTable struct {
	...
	Overwrite      bool        `orm:"overwrite"          json:"overwrite"`      // 是否覆盖原有文件
	SortColumn     string      `orm:"sort_column"        json:"sortColumn"`     // 缺省排序字段
	SortType       string      `orm:"sort_type"          json:"sortType"`       // 缺省排序方式 (asc顺序 desc倒序)
	ShowDetail     bool        `orm:"show_detail"        json:"showDetail"`     // 是否有查看详情功能
}
